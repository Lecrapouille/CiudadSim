...
int iFBPV(fname) char* fname;
{
    int l1, l2, l3, l4, l5, p1, p2, p3, uno = 1;
...
int isimplify(fname) char* fname;
{
    int l1, l2, p1, p2, p3;
